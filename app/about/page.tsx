              ...
              <div className="text-center">
                <div className="bg-gradient-to-br from-[#00d4d0]/10 to-[#00d4d0]/5 rounded-xl p-8">
                  <div className="flex items-center justify-center space-x-6 mb-6">
                    <div className="text-center">
                      <div className="w-20 h-20 bg-[#00d4d0] rounded-xl flex items-center justify-center mx-auto mb-2">
                    ...
                    <div className="text-center">
                      <div className="w-20 h-20 bg-gray-900 rounded-xl flex items-center justify-center mx-auto mb-2">
                        <span className="text-[#00d4d0] font-bold text-2xl">GD</span>
                      </div>
